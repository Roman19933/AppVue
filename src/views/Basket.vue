                      ...
                      <div class="count">
                        ...
                        >
                          <svg class="icon-svg icon-svg-plus plus">
                            <use
                              xlink:href="../assets/img/sprite.svg#plus"
                            ></use>
                          </svg>
                          <!-- <img src="img/.png" alt=""> -->
                        </a>
              ...
              <div class="basket__order-wrapper">
                ...
                <div class="basket__steps">
                    ...
                    <div class="basket__step-content">
                      <div class="basket__tab">
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          >
                            <div
                              class="basket__tab-content form-group_tab form-group error"
                            >
                              <label class="label">
                                <input
                                  type="radio"
                                  ...
                                  <div class="form-group form-group_np error">
                                    ...
                                    >
                                      ...
                                      <option value=""
                                        ...
                                        adipisicing elit. Itaque, iure.</option
                                      >
                                      <option value="">Point 2</option>
                                      <option value="">Point 3</option>
                                    </select>
                          ...
                          >
                            <div
                              class="basket__tab-content basket__tab-content_own"
                            >
                              <p>
                  ...
                  <div class="basket__step">
                    ...
                    <div
                      class="basket__step-content basket__step-content_payment form-group error"
                    >
                ...
                <div class="basket__feedback">
                  <a href="#" class="preventDefault"
                    >Оставить комментарий перед заказом</a
                  >
                  <div
                    class="form-group basket__feedback-content feedback-toggle"
                  >
                    <textarea></textarea>
                  </div>
                </div>
...
export default {
  data() {
    return {
      ...
      email:'',
      phone:'',
      townList:[{name:'sdsd'},{name:'dd'},{name:'asdasd'},{name:'луцьк'},{name:'рывне'}],
      town:[],
      searchs:''
    };
  },
  ...
  methods: {
    ...
    search:_.debounce((loading, search, vm) => { 
      const town = vm.townList.filter(item => {
